...
class Vendedores extends CI_Controller
{
	...
	public function edit($vendedor_id = NULL)
	{
		...
		if (!$vendedor_id || !$this->core_model->get_by_id('vendedores', array('vendedor_id' => $vendedor_id))) {
			...
			$this->form_validation->set_rules('vendedor_nome_completo', '', 'trim|required|min_length[4]|max_length[145]|callback_check_vendedor_nome_completo');
			$this->form_validation->set_rules('vendedor_cpf', '', 'trim|required|max_length[18]|callback_valida_cpf');
			...
			$this->form_validation->set_rules('vendedor_cep', '', 'trim|required|max_length[9]');
			...
			$this->form_validation->set_rules('vendedor_complemento', '', 'trim|required|max_length[45]');
...
//				exit();
	...
	public function add()
	{
		$this->form_validation->set_rules('vendedor_nome_completo', '', 'trim|required|min_length[4]|max_length[145]|is_unique[vendedores.vendedor_nome_completo]|callback_check_vendedor_nome_completo');
		$this->form_validation->set_rules('vendedor_cpf', '', 'trim|required|max_length[18]|is_unique[vendedores.vendedor_cpf]|callback_valida_cpf');
		$this->form_validation->set_rules('vendedor_rg', '', 'trim|required|max_length[20]|is_unique[vendedores.vendedor_rg]|callback_check_vendedor_rg');
		$this->form_validation->set_rules('vendedor_email', '', 'trim|required|valid_email|max_length[50]|is_unique[vendedores.vendedor_email]|callback_check_vendedor_email');
		$this->form_validation->set_rules('vendedor_telefone', '', 'trim|required|max_length[14]|is_unique[vendedores.vendedor_telefone]|callback_check_vendedor_telefone');
		$this->form_validation->set_rules('vendedor_celular', '', 'trim|required|max_length[15]|is_unique[vendedores.vendedor_celular]|callback_check_vendedor_celular');
...
//				exit();
	...
	public function check_vendedor_rg($vendedor_rg){
		...
		if ($this->core_model->get_by_id('vendedores', array('vendedor_rg' => $vendedor_rg,'vendedor_id !='=>$vendedor_id))){
			$this->form_validation->set_message('check_vendedor_rg','Esse documento já existe');
			return false;
		}else{
			return true;
		}
	...
	public function check_vendedor_nome_completo($vendedor_nome_completo){
		$vendedor_id = $this->input->post('vendedor_id');

		if ($this->core_model->get_by_id('vendedores', array('vendedor_nome_completo' => $vendedor_nome_completo,'vendedor_id !='=>$vendedor_id))){
			$this->form_validation->set_message('check_vendedor_nome_completo','Esse Nome já existe');
			return false;
		}else{
			return true;
		}
	...
	public function check_vendedor_telefone($vendedor_telefone)
	{
		...
		if ($this->core_model->get_by_id('vendedores', array('vendedor_telefone' => $vendedor_telefone, 'vendedor_id !=' => $vendedor_id))) {
			$this->form_validation->get_message('check_vendedor_telefone', 'Esse telefone já existe');
			return false;
		} else {
			return true;
		}
	...
	public function check_vendedor_celular($vendedor_celular)
	{
		...
		if ($this->core_model->get_by_id('vendedores', array('vendedor_celular' => $vendedor_celular, 'vendedor_id !=' => $vendedor_id))) {
			$this->form_validation->get_message('check_vendedor_celular', 'Esse celuar já existe');
			return false;
		} else {
			return true;
		}
