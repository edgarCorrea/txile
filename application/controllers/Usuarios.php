...
// essa configuração é para a pagina index da área usuários
...
//        exit();
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('last_name', 'Sobre Nome', 'trim|required');
        ...
        $this->form_validation->set_rules('confirm_senha', 'Confirma', 'matches[password]');
    ...
    //essa função faz parte da área de usuarios, quando puxa as informações
...
//        exit();
            ...
            if ($this->form_validation->run()) {
                ...
                /* Verifica de foi passado o password, caso em branco ele não lista junto */
    ...
    public function email_check($email) {
        $usuario_id = $this->input->post('usuario_id'); // esta puxando do hidden do formulário edit;;;
