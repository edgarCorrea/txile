			...
			<div class="card-header py-3">
				...
				<a title="Cadastrar novo usuário" href="<?php echo base_url('usuarios/add'); ?>"
				   class="btn btn-success btn-sm float-right">
					<li class="fas fa-user-plus">&nbsp;Novo Usuário</li>
				</a>
					...
					<table class="table table-bordered dataTables" width="100%" cellspacing="0">
						...
						<?php foreach ($usuarios as $user): ?>
							<tr>
								...
								<td><?php echo($user->active == 1 ? '<span class="badge badge-primary" btn-sm>Sim</span>' : '<span class="badge badge-warning">Não</span>'); ?></td>
								<td class="text-right">
									...
									<a title="Excluir" href="javascript(void)" data-toggle="modal"
									   data-target="#user-<?php echo $user->id; ?>" class="btn btn-sm btn-danger"><i
