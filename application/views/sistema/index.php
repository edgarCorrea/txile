				...
				<form method="POST" name="form_edit">
					<div class="form-group row mb-4">
						<div class="col-md-3">
							...
							<input type="text" class="form-control" name="sistema_razao_social" placeholder="Razão social"
						...
						<div class="col-md-3">
							...
							<input type="text" class="form-control" name="sistema_nome_fantasia" placeholder="Nome fantasia"
						...
						<div class="col-md-3">
							...
							<label>CNPJ</label>
							<input type="text" class="form-control cnpj" name="sistema_cnpj" placeholder="CNPJ"
						...
						<div class="col-md-3">
							...
							<input type="text" class="form-control" name="sistema_ie" placeholder="Inscrição estadual"
					...
					<div class="form-group row mb-4">
						<div class="col-md-3">
							...
							<input type="text" class="form-control phone_whith_add" name="sistema_telefone_fixo" placeholder="Telefone fixo"
						...
						<div class="col-md-3">
							...
							<input type="text" class="form-control phone_whith_add" name="sistema_telefone_movel" placeholder="Telefone móvel"
						...
						<div class="col-md-3">
							...
							<input type="text" class="form-control" name="sistema_site_url" placeholder="Url do site"
								   value="<?php echo $sistema->sistema_site_url; ?>">
							<?php echo form_error('sistema_site_url', ' <small class="form-text text-danger">', '</small>'); ?>
						</div>
						<div class="col-md-3">
							<label>E-mail</label>
							<input type="email" class="form-control" name="sistema_email" placeholder="E-mail"
