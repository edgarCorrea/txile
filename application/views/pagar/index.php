	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-2">
			<div class="card-header py-2">
				...
				<a title="Cadastrar novo marca" href="<?php echo base_url('pagar/add'); ?>"
				   class="btn btn-success btn-sm float-right">
					<li class="fas fa-plus-square">&nbsp;Nova conta</li>
				</a>
					...
					<table class="table table-bordered dataTables" width="100%" cellspacing="0">
						...
						<?php foreach ($contas_pagar as $conta): ?>
							<tr>
								...
								<td class="money"><?php echo 'R$&nbsp' . $conta->conta_pagar_valor; ?></td>
								<td><?php echo formata_data_banco_sem_hora($conta->conta_pagar_data_vencimento); ?></td>
								<td class="text-center"><?php echo($conta->conta_pagar_status == 1 ? formata_data_banco_com_hora($conta->conta_pagar_data_pagamento) : 'Aguardando pagamento'); ?></td>
							...
							<div class="modal fade" id="conta-<?php echo $conta->conta_pagar_id; ?>" tabindex="-1"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">Para excluir o registro <strong style="color: red"><?php echo $conta->conta_fornecedor; ?> </strong>
