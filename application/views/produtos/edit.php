			...
			<div class="card-body">
				...
				<form class="user" method="POST" name="form_edit">
					...
					<p><strong><i class="fas fa-clock">&nbsp;Última
								alteração: </i></strong>&nbsp;<?php echo formata_data_banco_com_hora($produto->produto_data_alteracao); ?>
					</p>
						...
						<div class="form-group row">
							...
							<div class="col-md-4">
								...
								<input type="text" class="form-control form-control-user" name="produto_codigo" readonly
									   value="<?php echo $produto->produto_codigo ?>">
							</div>
							<div class="col-md-8 ">
							...
							<div class="col-md-3 MB-3">
								...
								<select class="custom-select" name="produto_marca_id">
									<?php foreach ($marcas as $marca) : ?>
										<option value="<?php echo $marca->marca_id ?>"<?php echo($marca->marca_id == $produto->produto_marca_id ? 'selected' : '') ?> <?php echo($marca->marca_ativa == 0 ? 'disabled style="color: #EF4A4A"' : '') ?>><?php echo $marca->marca_nome ?></option>
									<?php endforeach; ?>
								</select>
							</div>
							...
							<div class="col-md-3 MB-3">
								...
								<select class="custom-select" name="produto_categoria_id">
									<?php foreach ($categorias as $categoria) : ?>
										...
										<option value="<?php echo $categoria->categoria_id ?>" <?php echo($categoria->categoria_id == $produto->produto_categoria_id ? 'selected' : '') ?><?php echo($categoria->categoria_ativa == 0 ? 'disabled style="color: #EF4A4A"' : '') ?>><?php echo $categoria->categoria_nome ?></option>
									<?php endforeach ?>
							...
							<div class="col-md-3 MB-3">
								...
								<select class="custom-select" name="produto_fornecedor_id">
									<?php foreach ($fornecedores as $fornecedor) : ?>
										...
										<option value="<?php echo $fornecedor->fornecedor_id ?>" <?php echo($fornecedor->fornecedor_id == $produto->produto_fornecedor_id ? 'selected' : '') ?><?php echo($fornecedor->fornecedor_ativo == 0 ? 'disabled style="color: #EF4A4A"' : '') ?>><?php echo $fornecedor->fornecedor_nome_fantasia ?></option>
									<?php endforeach ?>
